...
| Scripts Python | Tests fonctionnels | Manifeste SemVer, notification locale, chemins de sortie, erreurs de webhook et absence de fuite | MR, `dev`, `main` et tags | 7 tests réussissent | Rapport JUnit pytest |
